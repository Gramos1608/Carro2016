Public Class Form1
    ...
    Private Sub TSonIzq_TextChanged(sender As System.Object, e As System.EventArgs) Handles TSonIzq.TextChanged
        If Val(TSonIzq.Text) < Val(TSonar.Text) Then
        ...
        If (Val(TSonIzq.Text) < Val(TSonar.Text)) And (TVelDer.Text > 1) Then
            TVelDer.Text = 1
        ...
        If Val(TSonIzq.Text) < Val(TSonar.Text) And Val(TSonDer.Text) < Val(TSonar.Text) Then
            TVelDer.Text = TVel.Text
            If Com.IsOpen Then FRunDer_Click(0, Nothing)
        End If
    ...
    Private Sub TSonDer_TextChanged(sender As System.Object, e As System.EventArgs) Handles TSonDer.TextChanged
        If Val(TSonDer.Text) < Val(TSonar.Text) Then
        ...
        If Estado <> "1.Run" Then Exit Sub
        If (Val(TSonDer.Text) < Val(TSonar.Text)) And (TVelIzq.Text > 1) Then
            TVelIzq.Text = 1
    ...
    Private Sub TTacometro_TextChanged(sender As System.Object, e As System.EventArgs) Handles TTacometro.TextChanged
        If Val(TTacometro.Text) = 0 Then
            TTacometro.BackColor = Color.Red
        Else
            TTacometro.BackColor = Color.Green
        End If
